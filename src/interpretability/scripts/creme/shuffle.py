...
def dinuc_shuffle(seq, num_shufs=None, dims_to_exclude=0, rng=None, seed=None):
    """
    ...
    if type(seq) is str:
        ...
        arr = one_hot_to_tokens(seq, dims_to_exclude)
    else:
...
def one_hot_to_tokens(one_hot, dims_to_exclude=0):
    """
    ...
    """
    last_col = one_hot.shape[1] - dims_to_exclude
    one_hot = one_hot[..., 0:last_col]
