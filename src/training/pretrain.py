...
from dataloaders import GenomeIntervalDataset
from models import DeepSeq
...
class HyperParams:
    ...
    use_enformer_weights: bool = False
...
def main(output_dir: str, data_dir: str, hyperparams: HyperParams) -> None:
    ...
    if hyperparams.use_enformer_weights:
        model = transfer_enformer_weights_to_(model, transformer_only=True)
    if hyperparams.use_pretrained_weights:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--freeze-weights",
        type=bool,
        default=HyperParams.freeze_weights,
    )
    parser.add_argument(
        "--use-enformer-weights",
        type=bool,
        default=HyperParams.use_enformer_weights,
    )
    parser.add_argument(
        "--use-pretrained-weights",
        type=bool,
        default=HyperParams.use_pretrained_weights,
    )
    ...
    hyperparams = HyperParams(
        ...
        use_enformer_weights=args.use_enformer_weights,
