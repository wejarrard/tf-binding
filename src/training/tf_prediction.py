...
def main(output_dir: str, data_dir: str, hyperparams: HyperParams, train_file: str, valid_file: str) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train-file", type=str, default="training_combined.csv"
    )
    parser.add_argument(
        "--valid-file", type=str, default="validation_combined.csv"
    )
    ...
    main(args.output_dir, args.data_dir, hyperparams, args.train_file, args.valid_file)
