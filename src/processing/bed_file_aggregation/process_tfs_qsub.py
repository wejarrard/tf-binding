...
tf_list = [
    'AR', 'FOXA1', 'NR3C1', 'HDAC3', 'HOXB13', 'HDAC1', 'TP53', 'TRIM24', 'LEO1', 'SMARCA5', 'INO80', 'SMARCA4', 
...
#$ -pe smp 6
#$ -l mem_free=16G
#$ -o /data1/datasets_1/human_cistrome/chip-atlas/peak_calls/tfbinding_scripts/scripts/qsub_logs/{tf}.out
#$ -j y
#$ -V
